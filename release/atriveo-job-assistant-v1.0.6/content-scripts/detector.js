(function initAtriveoDetector() {
  ...
  const PLATFORM_MATCHERS = [
    ...
    { token: "careers.apple.com", platform: "genericcareer" },
    { token: "metacareers.com", platform: "genericcareer" },
    { token: "careers.microsoft.com", platform: "genericcareer" },
    { token: "tesla.com", platform: "genericcareer" },
    { token: "nvidia.com", platform: "genericcareer" },
    { token: "jobs.cisco.com", platform: "genericcareer" },
    { token: "jobs.intel.com", platform: "genericcareer" },
    { token: "careers.ibm.com", platform: "genericcareer" },
    { token: "oracle.com", platform: "genericcareer" },
    { token: "salesforce.com", platform: "genericcareer" },
    { token: "stripe.com", platform: "genericcareer" },
    { token: "careers.airbnb.com", platform: "genericcareer" },
    { token: "uber.com", platform: "genericcareer" },
    { token: "lyft.com", platform: "genericcareer" },
    { token: "snap.com", platform: "genericcareer" },
    { token: "openai.com", platform: "genericcareer" },
    { token: "anthropic.com", platform: "genericcareer" },
    { token: "spacex.com", platform: "genericcareer" },
    { token: "databricks.com", platform: "genericcareer" },
    { token: "coinbase.com", platform: "genericcareer" },
    { token: "careers.robinhood.com", platform: "genericcareer" },
    { token: "rivian.com", platform: "genericcareer" },
    { token: "boeing.com", platform: "genericcareer" },
    { token: "lockheedmartin.com", platform: "genericcareer" },
    { token: "rtx.com", platform: "genericcareer" },
    { token: "goldmansachs.com", platform: "genericcareer" },
    { token: "morganstanley.com", platform: "genericcareer" },
    { token: "careers.jpmorgan.com", platform: "genericcareer" },
    { token: "pinterestcareers.com", platform: "genericcareer" },
    { token: "dropbox.com", platform: "genericcareer" },
